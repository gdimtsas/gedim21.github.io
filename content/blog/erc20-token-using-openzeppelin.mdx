...
Let's keep building on the project setup that we did in the post <Link to="/blog/new-solidity-project-using-hardhat-and-typescript">Setup a Solidity project using Hardhat and Typescript</Link>. We will create a ERC-20 smart contract and deploy it on the Ethereum network.
